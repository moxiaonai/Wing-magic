const $modules = new function () {
    ...
    this.CommentForm = {
        ...
        data() {
            return {
                ...
                avatar: 'https://cravatar.cn/avatar/e40d491a5b8182e55f5dc8db37a51333?s=50&d=mystery',
                userId: '',
                form: {
    ...
    this.CommentItem = {
        ...
        computed: {
            ...
            commentDate() {
                console.log('this.comment.date', this.comment.date)
                    ...
                    <template v-if="!isEditor">
                        <div class="tile d-block">
                            ...
                            <div v-if="isPost" class="tile-footer text-gray text-tiny flex-center justify-between">
                                ...
                                <a v-if="isPost" class="btn btn-link btn-sm text-gray d-flex align-center a-link" :href="note.permalink">
                            ...
                            <div v-if="!isPost" class="tile-header flex-center justify-between">
                                ...
                                <slot name="right-icon">
                                    <div v-if="!isPost" class="dropdown mr-1" hover-show>
                                        ...
                                        <ul class="menu menu-left uni-card uni-bg uni-shadow bg-blur" style="overflow: unset; min-width: 4rem;">
                                            <div v-if="loading" class="loading loading-full"></div>
                                            <div class="text-center d-flex">
                                                <li v-if="!item.hide" :class="['menu-item d-inline-block tooltip mt-0', { 'ml-1': index}]" v-for="(item, index) in menus.icons" :key="item.id"
                                                    ...
                                                    <a :href="item.href || 'javascript:void(0);'" class="d-flex align-center">
                                                        <i v-if="item.icon" :class="[item.icon]"></i>
                                                    </a>
                                                </li>
                                            </div>
                                            <div v-if="logged && menus.texts.length" class="divider my-2" ></div>
                                            <li  v-if="logged" :class="['menu-item', item.class]" v-for="item in menus.texts" :key="item.id"  @click="debounceMenuClick(item)">
                                                <a :href="item.href || 'javascript:void(0);'" class="d-flex align-center">
            ...
            menus() {
                ...
                return {
                    ...
                    icons: [
                        ...
                        { id: 'quote', icon: "czs-bookmark-l", name: $lang.translate('Quote'), hide: !this.logged },
                        { id: 'edit', icon: 'czs-pen-write', name: $lang.translate('Edit'), hide: !this.logged },
